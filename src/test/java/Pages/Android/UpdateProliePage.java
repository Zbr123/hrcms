...
public class UpdateProliePage {
    ...
    public static String month_select(String mon){return "//button[normalize-space()='"+mon+"']";}

    public static String date_select(String date){return "(//div[normalize-space()='"+date+"'])[1]";}
    public static String second_date_select(String date){return "(//td[@class='ant-picker-cell ant-picker-cell-in-view']//div[@class='ant-picker-cell-inner'][normalize-space()='"+date+"'])[2]";}
    public static String expire_date_select(String date){return "(//div[@class='ant-picker-cell-inner'][normalize-space()='"+date+"'])[2]";}
    public static String second_expire_date_select(String date){return "(//div[@class='ant-picker-cell-inner'][normalize-space()='"+date+"'])[4]";}


    public static String user_month(String mon){return "//div[normalize-space()='"+mon+"']";}
